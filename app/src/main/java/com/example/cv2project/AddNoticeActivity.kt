...
class AddNoticeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AddNoticeScreen() { title, content, currentDate ->
...
@Composable
fun AddNoticeScreen(onSubmit: (String, String, String) -> Unit) {
    ...
    Column(
        ...
        Text("알림장 추가", fontSize = 24.sp, modifier = Modifier.padding(bottom = 16.dp))
